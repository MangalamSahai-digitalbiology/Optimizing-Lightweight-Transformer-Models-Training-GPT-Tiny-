...
#    parser.add_argument("--s1",default="Hello World",type=str)
#    parser.add_argument("--s2",default="Hellow WOrld",type=str)

#    args = parser.parse_args() 
#    o1 = test_not_injective(args.s1,args.s2)
#    o2 = test_not_invertible(args.s1,args.s2)
#    o3 = test_not_preserving_concat(args.s1,args.s2)
